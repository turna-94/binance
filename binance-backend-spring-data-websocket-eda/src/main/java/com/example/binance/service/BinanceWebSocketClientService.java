...
public class BinanceWebSocketClientService implements WebSocketHandler{  
	...
	public BinanceWebSocketClientService(WebSocketClient webSocketClient,ObjectMapper objectMapper,ApplicationEventPublisher eventPublisher) {
	...
	public void handleMessage(WebSocketSession session, WebSocketMessage<?> message) throws Exception {
		...
		var tradeEvent=objectMapper.readValue(payload, TradeEvent.class);
	...
	@Override
	public boolean supportsPartialMessages() {  //Başı sonu belli olmayan message
